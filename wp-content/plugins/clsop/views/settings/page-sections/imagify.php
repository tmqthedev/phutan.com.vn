...
<div id="imagify" class="wpr-Page">
	...
	<div class="wpr-imagify">
		<div class="wpr-imagify-description">
			...
			printf( esc_html__( '%1$sAccelerateWP%2$s created %3$sIMAGIFY%4$s %1$sfor best-in-class image optimization.%2$s', 'rocket' ), '<strong>', '</strong>', '<span class="wpr-imagify-name">', '</span>' );
			?>
			</p>
		...
		<div class="wpr-imagify-screenshot">
			<img src="<?php echo esc_url( WP_ROCKET_ASSETS_IMG_URL ); ?>imagify.jpg?ver=<?php echo esc_attr( time() ); ?>" alt="" width="613" height="394">
		</div>
	</div>
</div>
