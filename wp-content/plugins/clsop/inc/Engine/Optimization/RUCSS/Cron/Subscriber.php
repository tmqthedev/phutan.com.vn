...
class Subscriber implements Subscriber_Interface {
	...
	public function add_interval( $schedules ) {
		...
		$schedules['rocket_rucss_pending_jobs'] = [
			'interval' => $interval,
			'display'  => esc_html__( 'AccelerateWP Remove Unused CSS pending jobs', 'rocket' ),
		];
		...
		$schedules['rocket_remove_rucss_failed_jobs'] = [
			'interval' => $interval,
			'display'  => esc_html__( 'AccelerateWP clear Remove Unused CSS failed jobs', 'rocket' ),
		];
		...
		$schedules['rocket_rucss_on_submit_jobs'] = [
			'interval' => $interval,
			'display'  => esc_html__( 'AccelerateWP procees on submit jobs', 'rocket' ),
		];
