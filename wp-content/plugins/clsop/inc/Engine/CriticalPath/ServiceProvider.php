...
class ServiceProvider extends AbstractServiceProvider {
	...
	protected $provides = [
		...
		'cpcss_api_client_subscriber',
		'cpcss_api_client',
		'cpcss_data_manager',
		'cpcss_options_manager',
		'cpcss_service',
		'rest_cpcss_wp_post',
	...
	public function register() {
		...
		// CCSS options manager.
		$this->getContainer()->add( 'cpcss_options_manager', CCSSAWPOptionsManager::class )
			->addArgument( $this->getContainer()->get( 'options_api' ) )
			->addArgument( $options );
		$this->getContainer()->share( 'cpcss_api_client', APIClient::class )
			->addArgument( $this->getContainer()->get( 'cpcss_options_manager' ) );
		...
		$this->getContainer()->share( 'cpcss_api_client_subscriber', ApiClientSubscriber::class )
		->addArgument( $this->getContainer()->get( 'cpcss_api_client' ) )
		->addArgument( $this->getContainer()->get( 'cpcss_options_manager' ) );
	}
}
