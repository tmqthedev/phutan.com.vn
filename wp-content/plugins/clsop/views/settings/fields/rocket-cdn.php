...
?>
<div class="wpr-fieldsContainer-fieldset" style="display: none;">
	<div class="wpr-field">
		...
		<?php else : ?>
			<div class="wpr-text">
				...
				<input type="text" id="cdn_cnames" name="wp_rocket_settings[cdn_cnames][]" value="" placeholder="cdn.example.com" />
...
<div class="wpr-optionHeader">
	<h3 class="wpr-title2"><?php esc_html_e( 'Purge CDN cache', 'rocket' ); ?></h3>
</div>
<div class="wpr-fieldsContainer">
	<div class="wpr-fieldsContainer-description">
		...
		printf(
			...
			esc_html__( 'Purges CDN cached resources for your website.', /*%s',*/ 'rocket' ),
	...
	$this->render_action_button(
		...
		[
			'label'      => __( 'Clear all CDN cache files', 'rocket' ),
			'attributes' => [
