...
<div class="wpr-Sidebar-notice">
	...
	<a href="<?php echo esc_url( 'https://cloudlinux.com/blog/how-to-test-wordpress-site-performance-measure-speed-results/?utm_source=wp_plugin&utm_medium=cloudlinux_site_optimization_plugin' ); ?>" target="_blank" rel="noopener" class="wpr-Sidebar-notice-link"><?php esc_html_e( 'Read our guide', 'rocket' ); ?></a>
</div>
*/
?>
<?php
...
<div class="wpr-Sidebar-notice">
	...
	$rocket_mobile_doc_url = false !== strpos( get_locale(), 'fr' )
			? 'https://fr.docs.cloudlinux.com/article/1432-comment-ameliorer-score-mobile-pagespeed/?utm_source=wp_plugin&utm_medium=cloudlinux_site_optimization_plugin'
			: 'https://docs.cloudlinux.com/article/1402-how-to-improve-your-mobile-pagespeed-score/?utm_source=wp_plugin&utm_medium=cloudlinux_site_optimization_plugin'
	?>
...
<div class="wpr-Sidebar-notice">
	...
	<?php
	/*
	<a href="<?php echo esc_url( 'https://cloudlinux.com/google-core-web-vitals-wordpress/?utm_source=wp_plugin&utm_medium=cloudlinux_site_optimization_plugin' ); ?>" target="_blank" class="wpr-Sidebar-notice-link"><?php esc_html_e( 'Read more', 'rocket' ); ?></a>
	*/
	?>
</div>
