...
class Settings {
	...
	public function sanitize_callback( $input ) {
		...
		// CL.
		$input['addon_varnish_used']    = isset( $input['addon_varnish_used'] ) ? $input['addon_varnish_used'] : $this->options->get( 'addon_varnish_used', 0 );
		$input['addon_webp_used']       = isset( $input['addon_webp_used'] ) ? $input['addon_webp_used'] : $this->options->get( 'addon_webp_used', 0 );
		$input['addon_cloudflare_used'] = isset( $input['addon_cloudflare_used'] ) ? $input['addon_cloudflare_used'] : $this->options->get( 'addon_cloudflare_used', 0 );
