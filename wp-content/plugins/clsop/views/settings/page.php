...
<div class="wpr-wrap wrap">
	<h1 class="screen-reader-text"><?php esc_html_e( 'AccelerateWP Settings', 'rocket' ); ?></h1>
	<div class="wpr-body">

		<header class="wpr-Header">
			<div class="wpr-Header-logo">
				<img src="<?php echo esc_url( WP_ROCKET_ASSETS_IMG_URL . 'logo-acceleratewp.svg' ); ?>" width="200" height="44" alt="Logo AccelerateWP" class="wpr-Header-logo-desktop">
				<img src="<?php echo esc_url( WP_ROCKET_ASSETS_IMG_URL . 'picto-acceleratewp.svg' ); ?>" width="28" height="28" alt="Logo AccelerateWP" class="wpr-Header-logo-mobile">
			</div>
	...
	<div class="wpr-Popin wpr-Popin-Analytics">
		...
		<div class="wpr-Popin-content">
			...
			<?php
				...
				printf( esc_html__( 'Below is a detailed view of all data AccelerateWP will collect %1$sif granted permission.%2$s', 'rocket' ), '<strong>', '</strong>' );
			?>
			</p>
			...
			<div class="wpr-Popin-flex">
				<p><?php esc_html_e( 'AccelerateWP will never transmit any domain names or email addresses (except for license validation), IP addresses, or third-party API keys.', 'rocket' ); ?></p>
				<div>
