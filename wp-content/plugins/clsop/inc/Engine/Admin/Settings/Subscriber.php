...
class Subscriber implements Subscriber_Interface {
	...
	public function enqueue_url() {
		wp_localize_script(
			...
			[
				'rest_url_option_export' => rest_url( 'clsop/v1/options/export/' ),
			]
		);
	}
	...
	public function add_menu_tools_page( $navigation ) {
		$navigation['tools'] = [
			...
			'menu_description' => __( 'Import, Export', 'rocket' ),
	...
	/**
	 * Add About section to navigation.
	 *
	 * @since 3.0
	 *
	 * @param array $navigation Array of menu items.
	 * @return array
	 */
	public function add_menu_about_page( $navigation ) {
		$navigation['about'] = [
			'id'               => 'about',
			'title'            => __( 'About', 'rocket' ),
			'menu_description' => __( 'Plugin info', 'rocket' ),
			// 'menu_description' => __( 'Import, Export, Rollback', 'rocket' ),
		];
