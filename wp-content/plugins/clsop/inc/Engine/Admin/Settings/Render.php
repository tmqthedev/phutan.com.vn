...
class Render extends Abstract_render {
	...
	/**
	 * Render the about page section.
	 *
	 * @since 3.12.6
	 */
	public function render_about_section() {
		echo $this->generate( 'page-sections/about' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Dynamic content is properly escaped in the view.
	}
