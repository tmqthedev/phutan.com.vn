...
<div id="<?php echo esc_attr( $data['id'] ); ?>" class="wpr-Page">
	...
	<div class="wpr-notice">
		<div class="wpr-notice-container">
			...
			<?php esc_html_e( 'AccelerateWP is now activated and already working for you.', 'rocket' ); ?>
			<br>
			<?php esc_html_e( 'Your website should be loading faster now!', 'rocket' ); ?>
			</h2>
				<div class="wpr-notice-description"><?php esc_html_e( 'To guarantee fast websites, AccelerateWP automatically applies 80% of web performance best practices.', 'rocket' ); ?><br> <?php esc_html_e( 'We also enable options that provide immediate benefits to your website.', 'rocket' ); ?></div>
	...
	<div class="wpr-Page-row">
		...
		<div class="wpr-Page-col">
			...
			<?php
			/**
			 * Fires after the account data section on the AccelerateWP settings dashboard
			 *
			 * @since 3.5
			 *
